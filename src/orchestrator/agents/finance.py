...
class FinanceAgent(BaseAgent):
    ...
    async def run(self, task: Any, state: ExecutionState | None = None) -> str:
        ...
        system_prompt = """You are a finance agent. You have access to a web search tool. 
        Given a query about financial data or stock information, decide if you need to search the web. 
        If yes, return a tool call to web_search with a query suitable for finding financial information.
